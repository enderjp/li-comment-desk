...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const { user_id, post_id, adset } = await req.json();
    ...
    const title = "Script actualizado";
    const message = adset
      ? `El script para el adset "${adset}" ha sido actualizado exitosamente.`
      : "El script ha sido actualizado exitosamente.";
